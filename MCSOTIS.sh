...
then
     ...
     git clone https://github.com/AtherMage/Spigot_1.15.2_Data  
     cd ..   
     wget https://cdn.getbukkit.org/spigot/spigot-1.15.2.jar  
     chmod +x spigot-1.15.2.jar  
     java -Xms512M -Xmx2048M -jar spigot-1.15.2.jar 
     rm -r eula.txt  
     cd MCSOTIS  
...
then
     ...
     java -Xms512M -Xmx1536M -jar spigot-1.14.4.jar  
     rm -r eula.txt  
     cd MCSOTIS  
...
then
     ...
     java -Xms512M -Xmx1536M -jar spigot-1.12.2.jar  
     rm -r eula.txt  
     cd MCSOTIS  
